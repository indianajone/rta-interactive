...
class PlacesPanoramaController extends Controller
{
    ...
    public function store(Request $request, $placeId) 
    {
        ...
        $attachment = $place->panoramas()->create($this->transformer->transform($request->all()));
        ...
        if ($request->hasFile('image')) {
            ...
            $attachment->path = sprintf("%s/%s", 'uploaded/panoramas', $attachment->name);
            $attachment->thumbnail_path = sprintf("%s/tn-%s", 'uploaded/panoramas', $attachment->name);
        ...
        flash()->success('Created!', 'Panorama has been created.');
    ...
    public function update(Request $request, $placeId, $id) 
    {
        ...
        $attachment =  $place->panoramas()->find($id);
        ...
        flash()->success('Update!', 'Panorama has been updated.');
