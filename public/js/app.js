...
},{"./components/InteractiveMap":19,"./components/Modal":20,"./components/Panorama":23,"./components/Search":24,"./pages/PlaceFilter":35,"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":2,"underscore":4,"vue":14,"vue-chunk":5,"vue-resource":7}],16:[function(require,module,exports){
'use strict';
...
},{"./destination.template.html":26}],17:[function(require,module,exports){
'use strict';
...
},{"./InfoWindow":18,"./google-map.template.html":27}],18:[function(require,module,exports){
'use strict';
...
},{"./info-window.template.html":28}],19:[function(require,module,exports){
'use strict';
...
},{"./Destination":16,"./GoogleMap":17,"./Mode":21,"./Origin":22,"./Waypoint":25,"./interactive-map.template.html":29}],20:[function(require,module,exports){
'use strict';
...
},{"./modal.template.html":30}],21:[function(require,module,exports){
'use strict';
...
},{"./mode.template.html":31}],22:[function(require,module,exports){
'use strict';
...
},{"./origin.template.html":32}],23:[function(require,module,exports){
'use strict';
...
},{"../vendor/jquery.panorama-viewer.js":37}],24:[function(require,module,exports){
'use strict';
...
},{"./search.template.html":33}],25:[function(require,module,exports){
'use strict';
...
},{"../vendor/Sortable.min.js":36,"./waypoint.template.html":34}],26:[function(require,module,exports){
    ...
    filters: {
        inCategory: function inCategory(places) {
            ...
            var result = _.filter(places, function (place) {
                return _.intersection(_.toArray(place.categories), self.filteredBy.map(Number)).length > 0;
            });
