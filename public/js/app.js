...
Vue.filter('inCategory', function (places) {
    ...
    return _.filter(places, function (place) {
        return _.intersection(_.toArray(place.categories), _.flatten(_this.filteredBy.map(Number))).length === _this.filteredBy.length;
    });
});
...
module.exports = {
    ...
    filters: {
        children: function children(places) {
            var _this = this;

            if (!this.filteredBy.length) return places;

            return _.filter(places, function (place) {
                return _this.isInCategory(place.categories);
            });
        }
    },
...
},{"../vendor/RouteBoxer":43,"./InfoWindow":21}],20:[function(require,module,exports){
'use strict';
...
},{"./templates/info-window.html":33}],22:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    computed: {
        ...
        selectedWaypoint: function selectedWaypoint() {
...
},{"./Destination":17,"./GoogleMap":19,"./GooglePanel":20,"./Mode":26,"./Origin":27,"./Waypoint":32}],23:[function(require,module,exports){
'use strict';
...
exports['default'] = {
    ...
    methods: {
        ...
        login: function login() {
            ...
            this.$http.post('/api/login', credentials).success(function (data) {
                window.location.reload();
            }).error(function (errors) {
                _this.password = '';
                _this.errors = _.flatten(_.toArray(errors));
            });
        },
...
exports['default'] = {
    ...
    methods: {
        logout: function logout() {
            this.$http['delete']('/api/logout').then(function (data) {
                window.location.reload();
            });
        }
    }
...
},{"./templates/modal.html":34}],26:[function(require,module,exports){
'use strict';
...
},{"./templates/mode.html":35}],27:[function(require,module,exports){
'use strict';
...
},{"./templates/readmore.html":36}],30:[function(require,module,exports){
'use strict';
...
exports['default'] = {
    ...
    template: '<a role="button" tabindex="0" v-socials :url="url"><i class="fa fa-lg fa-share-alt"></i></a>',
...
},{"../vendor/Sortable.min.js":44,"./templates/waypoint.html":37}],33:[function(require,module,exports){
...
},{"bootstrap-sass/assets/javascripts/bootstrap":1,"jquery":2,"underscore":5,"vue":15,"vue-chunk":6,"vue-resource":8}],39:[function(require,module,exports){
'use strict';
...
},{"slick-carousel":4}],40:[function(require,module,exports){
'use strict';
...
},{"../vendor/dropdown-checkbox":45}],41:[function(require,module,exports){
'use strict';
...
},{"../vendor/js-social":47}],42:[function(require,module,exports){
'use strict';
...
!(function ($) {
    ...
    function touchHandler(event) {
        ...
        simulatedEvent.initMouseEvent(type, true, true, window, 1, first.screenX, first.screenY, first.clientX * mult, first.clientY * mult, false, false, false, false, 0, /*left*/null);
...
(function (window, $, undefined) {
    ...
    Socials.prototype = {
        ...
        _createShareLink: function _createShareLink(share) {
            var $result = $("<a>").addClass(this.shareLinkClass).attr({ href: this._getShareUrl(share), target: "_blank" }).append(this._createShareLogo(share));
...
(function (window, factory) {
    ...
    function inlineHandler(target) {
        ...
        return el.after(placeholder).on('lity:ready', function (e, instance) {
            instance.one('lity:remove', function () {
                placeholder.before(el.addClass('lity-hide')).remove();
            });
        });
    }
    ...
    function iframeHandler(target) {
        ...
        if (matches) {
            url = appendQueryParams(protocol() + '//www.youtube' + (matches[2] || '') + '.com/embed/' + matches[4], $.extend({
                autoplay: 1
        ...
        if (matches) {
            url = appendQueryParams(protocol() + '//player.vimeo.com/video/' + matches[3], $.extend({
                autoplay: 1
        ...
        if (matches) {
            url = appendQueryParams(protocol() + '//www.google.' + matches[3] + '/maps?' + matches[6], {
    ...
    function lity(options) {
        ...
        function resize() {
            ...
            _content.css('max-height', Math.floor(height) + 'px').trigger('lity:resize', [_instance, popup]);
        }
        ...
        function ready(content) {
            ...
            _instance.find('.lity-loader').each(function () {
                var el = $(this);
            ...
            _instance.removeClass('lity-loading').find('.lity-content').empty().append(_content);

            _content.removeClass('lity-hide').trigger('lity:ready', [_instance, popup]);
        ...
        function init(handler, content, options) {
            ...
            _instance = $(options.template).addClass('lity-loading').appendTo('body');
            ...
            setTimeout(function () {
                _instance.addClass('lity-opened lity-' + handler).on('click', '[data-lity-close]', function (e) {
        ...
        function open(target, options) {
            var handler,
                content,
                handlers = $.extend({}, _defaultHandlers, _handlers);
            ...
            if (options.handler && handlers[options.handler]) {
                ...
                var call = function call(name, callback) {
        ...
        function close() {
            ...
            _ready.done(function () {
                ...
                _win.off('resize', resize).off('keyup', keyup);

                _content.trigger('lity:close', [_instance, popup]);

                _instance.removeClass('lity-opened').addClass('lity-closed');
        ...
        function popup(event) {
            ...
            var options = $.extend({}, _defaultOptions, _options, el.data('lity-options') || el.data('lity'));
